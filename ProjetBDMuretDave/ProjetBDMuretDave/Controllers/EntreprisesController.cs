...
namespace ProjetBDMuretDave.Controllers
{
    public class EntreprisesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Numero,Denomination,Adresse,Telephone")] Entreprise entreprise)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Numero,Denomination,Adresse,Telephone")] Entreprise entreprise)
        {
            if (ModelState.IsValid)
            {
