...
namespace ProjetBDMuretDave.Controllers
{
    public class PersonnesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdPersonne,Nom,Adresse,DateEntree,DateSortie")] Personne personne)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdPersonne,Nom,Adresse,DateEntree,DateSortie")] Personne personne)
        {
            if (ModelState.IsValid)
            {
